                            ...
                            <div class="user-items ps-5">
                                <ul class="d-flex justify-content-end list-unstyled">
                                    ...
                                    if (isset($_SESSION['logged_in']) && $_SESSION['logged_in'] === true) {
                                        ...
                                        echo '<li class="pe-3">Xin chào, ' . $_SESSION['Username'] . '</li>';
                                        echo '<li class="pe-3"><a href="./admin/logout.php">Logout</a></li>'; // Liên kết đến trang logout.php để đăng xuất
                                    } else {
                                    ...
                                    ?>
                                    <li>
                                        <a href="#" onclick="addModalCart()" data-toggle="modal"
