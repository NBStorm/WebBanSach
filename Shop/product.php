...
<?php 
   ...
   $id = $_GET["MaSP"];
   $query="SELECT s.MaSP,s.TenSP,s.DonGia,s.HinhAnh, n.TenTL as Tentheloai,s.MaTL
   from sanpham s 
   LEFT JOIN theloai n on n.MaSP = s.MaTL
	WHERE  s.MaSP =".$id;
...
if(isset($_POST['submit']))
{
    ...
    $sl;
        ...
        echo "<script>window.location.replace('http://localhost/webbansach/.org/cart.php'); </script>";
			...
			<div class="row">
				<div class="col-lg-12">
					<ul class="breadcrumb">
						...
						<li><a href="#">Sách</a></li>
						<li><a href="#"><?php echo $row["TenSP"]?></a></li>
					</ul>
				</div>
			</div>
			<div class="row">
				...
				<div id="main-content" class="col-md-8">
					<div class="product">
						...
						<div class="col-md-6">
							<div class="caption">
								<div class="name"><h5><?php echo $row["TenSP"]?></h5></div>
								<div class="info">
									<ul>

										<li>Nhà cung cap: <a href="/category.php?manhasx=<?php echo $row["MaNCC"]?>"><?php echo $row["TenNCC"]?></a> <h3></li>
									</ul>
								</div>
								<?php
